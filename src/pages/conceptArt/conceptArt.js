...
const ConceptArtPage = ({ content, footerData }) => {
  const breadcrumbItems = [
    { label: 'Home', link: '/index.html' },
    { label: 'Concept Art', link: '/conceptArt/conceptArt-list-1.html' },
  ...
  return React.createElement('div', { className: 'page-container scrollable-page' },
    ...
    React.createElement('main', { className: 'concept-art-detail-content' },
      React.createElement(Breadcrumb, { items: breadcrumbItems }),
      React.createElement('div', { className: 'concept-art-detail' },
        // Title
...
exports.ConceptArtPage = ConceptArtPage;
