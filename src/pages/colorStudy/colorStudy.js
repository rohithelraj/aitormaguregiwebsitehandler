...
const ColorStudyPage = ({ content, footerData }) => {
  const breadcrumbItems = [
    { label: 'Home', link: '/index.html' },
    { label: 'Color Study', link: '/colorStudy/colorStudy-list-1.html' },
  ...
  return React.createElement('div', { className: 'page-container scrollable-page' },
    ...
    React.createElement('main', { className: 'color-study-detail-content' },
      React.createElement(Breadcrumb, { items: breadcrumbItems }),
      React.createElement('div', { className: 'color-study-detail' },
        // Title
...
exports.ColorStudyPage = ColorStudyPage;
