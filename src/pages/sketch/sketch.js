...
const SketchPage = ({ content, footerData }) => {
  const breadcrumbItems = [
    { label: 'Home', link: '/index.html' },
    { label: 'Sketch', link: '/sketch/sketch-list-1.html' },
  ...
  return React.createElement('div', { className: 'page-container scrollable-page' },
    ...
    React.createElement('main', { className: 'sketch-detail-content' },
      React.createElement(Breadcrumb, { items: breadcrumbItems }),
      React.createElement('div', { className: 'sketch-detail' },
        // Title
